      ...
      <div class="modal-content" @mousedown.stop>
        ...
        <div class="modal-body">
          ...
          <FormField
            ...
            readonly
          />
          <button class="btn-select-file" @click="handleBrowseFile">
            选择文件
          </button>
...
export default {
  ...
  computed: {
    canSubmit() {
      return this.formData.name && this.formData.name.trim() && this.formData.filePath && this.formData.filePath.trim()
    }
  },
  watch: {
    visible(newVal) {
  ...
  methods: {
    loadFileData() {
      ...
      this.formData = {
        ...
        tags: Array.isArray(this.file.tags) ? [...this.file.tags] : []
      }
      this.tagInput = ''
    },
    handleClose() {
